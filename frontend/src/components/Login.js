...
>>>>>>> 0a4c07c8c0742801e492ec62df98f29aa87cda5e
...
=======
                ...
                {/* <img className="pt-8 pl-56 h-auto" src={require('../images/clumsy_w_jobs.png')} alt="notfsadasduppypng"></img> */}
            </div>

            <div className="flex bg-secpurple w-2/5 h-full">

                <form className="w-full max-w-lg items-center pl-48 pt-40">

                    <div className="flex items-center w-3/4 border-b border-darkpurple py-2">
                        <input className="appearance-none bg-transparent border-none text-gray-700 mr-3 py-1 px-2 leading-tight focus:outline-none w-3/4" type="text" placeholder="Username or email"></input>
                    </div>

                    <div className="flex items-center w-3/4 border-b border-darkpurple py-2 pt-10">
                        <input className="appearance-none bg-transparent border-none text-gray-700 mr-3 py-1 px-2 leading-tight focus:outline-none w-3/4" type="password" placeholder="Password"></input>
                    </div>

                    <div className="flex inline w-3/4 pt-10">
                        <Link to="/Home">
                        <button className="w-16 h-8 bg-darkpurple2 hover:bg-secpurple text-white rounded" type="button">Login</button>
                        </Link>
                        <a className="w-2">  </a>

                        {/* POPUP */}
                        <button onClick={ this.showModal } className="w-20 h-8 bg-mainpink hover:bg-secpurple text-white rounded" type="button">Sign up</button>
                        <Modal show={ this.state.show } handleClose={this.hideModal}>
                        </Modal>
                        {/* POPUP */}

                        <button className="text-xs text-darkpurple2 font-bold" type="button">Forgot Password?</button>
                    </div>
>>>>>>> 0a4c07c8c0742801e492ec62df98f29aa87cda5e
